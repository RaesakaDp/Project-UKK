...
<div class="card">
    ...
    <a href="user.php?url=catatan_perjalanan" class="btn btn-primary btn-icon-split">
        <span class="icon text-white-50">
            ...
            <span btn-sm class="text">Kembali</span>
        </a>
    </div>
    <div class="card-body">
        <form method="post" action="simpan_edit_catatan.php">
            ...
            <div class="form-group">
                ...
                <input value="<?= $value['tgl']?>" name="tgl" class="form-control" type="date" placeholder="Pilih Tanggal" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input name="lokasi" value="<?= $value['lokasi']?>" class="form-control" type="text" placeholder="Masukkan Lokasi Perjalanan" required>
            </div>
            <div class="form-group">
                <label> Suhu Tubuh</label>
                <input name="suhu" value="<?= $value['suhu']?>" class="form-control" type="text" placeholder="Masukkan Suhu Tubuh" required>
            </div>
            <div class="form-group">
